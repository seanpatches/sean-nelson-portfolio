    ...
    <Layout>
      ...
      <div className={styles.projects} >
        <div className={styles.unwasted}>
          <UnwastedProjectThumb name={unwasted.name} description={unwasted.description} firstImage={unwasted.firstImage} secondImage={unwasted.secondImage} link={unwasted.link} tech={unwasted.tech} />
        </div>
